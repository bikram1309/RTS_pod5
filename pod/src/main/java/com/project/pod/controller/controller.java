...
public class controller {
	...
	public String register_form(Model model) {
	 ...
	 throws UnsupportedEncodingException,MessagingException{ 
		 ModelAndView mav;
		 if(errors.hasErrors()) {mav=new ModelAndView("register");mav.addObject("users",users);return mav;} 
		 else if(service.findUser(users)){
			 mav=new ModelAndView("register");mav.addObject("message","You are already register with this EmailID");return mav;
		 }
